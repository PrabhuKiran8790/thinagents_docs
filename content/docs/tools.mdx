...
## LangChain Tool Example: Tavily Search
...
You can use [**Agno**](https://www.agno.com) toolkits in Thinagents via the `AgnoTool` adapter. Here's how to use the YFinance toolkit for financial data:
...
## Combo Example: Datetime, LangChain (Tavily), and Agno (YFinance)

You can combine your own Python tools, LangChain tools, and Agno toolkits in a single agent for maximum versatility:

```py
from thinagents import Agent
from thinagents.tools import LangchainTool, AgnoTool
from langchain_tavily import TavilySearch
from agno.tools.yfinance import YFinanceTools
import datetime
...
<Callout title="Tip">
You can mix and match any number of LangChain, Agno, or regular Python tools in your agent's toolset.
</Callout>
