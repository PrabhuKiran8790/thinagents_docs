...
You can use [**CrewAI**](https://github.com/joaomdmoura/crewAI) tools directly in Thinagents via the `CrewaiTool` adapter. This allows you to wrap any CrewAI `BaseTool` and use it seamlessly in your agent, just like with LangChain tools.
